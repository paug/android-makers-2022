...
export const theme = css`
  :host {
    --dark-primary-color: #4db6e3;
    --default-primary-color: #4db6e3;
    --focused-color: #ff5252;
    --light-primary-color: #4db6e3;
    ...
    --box-shadow-primary-color: 0 3px 3px -2px rgb(77, 182, 227 / 30%),
      0 3px 4px 0 rgb(77, 182, 227 / 30%), 0 1px 8px 0 rgb(77, 182, 227 / 30%);
    --box-shadow-primary-color-hover: 0 1px 3px -2px rgb(77, 182, 227 / 40%),
      0 4px 5px 0 rgb(77, 182, 227 / 40%), 0 2px 9px 0 rgb(77, 182, 227 / 40%);
    --font-family: -apple-system, blinkmacsystemfont, 'Segoe UI', roboto, helvetica, arial,
      sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
    --max-container-width: 1280px;
    --primary-color-transparent: rgb(77, 182, 227 / 10%);
    --primary-color-light: rgb(77, 182, 227 / 80%);
